#!/bin/bash
#SBATCH --job-name=prm_qwen3_80b_full500
#SBATCH --output=sbatch_logs/prm_qwen3_80b_full500_%j.out
#SBATCH --error=sbatch_logs/prm_qwen3_80b_full500_%j.err
...
#
# Submit:
#   sbatch scripts/run_prm_qwen3_80b_full500_concise_step_aware_k10.sh
#
# Attach:
#   ./connect_job.sh <jobid> prm_qwen3_80b_full
...
echo "=== qwen3-80b agent + concise step_aware k=10 PRM (trained r2egym-swebench-instructions-k5) full 500 ==="
...
INNER_SCRIPT="/home/srgandhi/tool-overuse/sbatch_logs/prm_qwen3_80b_full500_${SLURM_JOB_ID:-manual}_inner.sh"
...
keep_tunnel >> /home/srgandhi/tool-overuse/sbatch_logs/prm_qwen3_80b_full500_tunnel_$(hostname).log 2>&1 &
TUNNEL_PID=$!
...
echo
echo "=== prm_qwen3_80b_full500 done at $(date) (rc=$rc) ==="
...
tmux new-session -d -s prm_qwen3_80b_full "$INNER_SCRIPT"

echo "=== Launched tmux session 'prm_qwen3_80b_full' on $(hostname) ==="
echo "Inner script: $INNER_SCRIPT"
echo "To attach:    ./connect_job.sh ${SLURM_JOB_ID:-<jobid>} prm_qwen3_80b_full"
