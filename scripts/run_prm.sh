...
#
# Usage:
#   ./run_prm.sh <setting> <prm_interval> <run> <agent_model> [options]
#
# Settings:
...
#   ./run_prm.sh prm_tool 5 0 cwm --slice :500
#   ./run_prm.sh prm_issue_res 5 0 cwm --slice :500
#   ./run_prm.sh prm_tool_issue_res 5 0 cwm --slice :500
#
#   # vLLM PRM on a remote node
#   ./run_prm.sh prm_issue_res 5 0 cwm --prm sweagent7b --prm-node babel-1-23
#   ./run_prm.sh prm_tool 5 0 cwm --prm qwen3-8b --prm-node babel-1-23 --agent-node babel-s5-24
#
#   # v0/v1 variants
#   ./run_prm.sh prm_tool_v0 5 0 cwm --slice :500
#   ./run_prm.sh prm_tool_v1_issue_res 3 0 cwm --prm cwm --prm-node babel-5-32
...
if [ -z "$SETTING" ] || [ -z "$PRM_INTERVAL" ] || [ -z "$RUN" ] || [ -z "$AGENT_MODEL" ]; then
    echo "Usage: ./run_prm.sh <setting> <prm_interval> <run> <agent_model> [options]"
    echo ""
    ...
    echo ""
    echo "Examples:"
    echo "  ./run_prm.sh prm_tool 5 0 cwm --slice :500"
    echo "  ./run_prm.sh prm_issue_res 5 0 cwm --prm sweagent7b --prm-node babel-1-23"
    exit 1
fi
