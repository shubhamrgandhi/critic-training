#!/bin/bash
#SBATCH --job-name=prm_qwen32b_k10_full500
#SBATCH --output=sbatch_logs/prm_qwen32b_k10_full500_%j.out
#SBATCH --error=sbatch_logs/prm_qwen32b_k10_full500_%j.err
...
#
# Submit:
#   sbatch scripts/run_prm_qwen32b_full500_concise_step_aware_k10.sh
#
# Attach:
#   ./connect_job.sh <jobid> prm_qwen32b_k10_full
...
INNER_SCRIPT="/home/srgandhi/tool-overuse/sbatch_logs/prm_qwen32b_k10_full500_${SLURM_JOB_ID:-manual}_inner.sh"
...
keep_tunnel >> /home/srgandhi/tool-overuse/sbatch_logs/prm_qwen32b_k10_full500_tunnel_$(hostname).log 2>&1 &
TUNNEL_PID=$!
...
echo
echo "=== prm_qwen32b_k10_full500 done at $(date) (rc=$rc) ==="
...
tmux new-session -d -s prm_qwen32b_k10_full "$INNER_SCRIPT"

echo "=== Launched tmux session 'prm_qwen32b_k10_full' on $(hostname) ==="
echo "Inner script: $INNER_SCRIPT"
echo "To attach:    ./connect_job.sh ${SLURM_JOB_ID:-<jobid>} prm_qwen32b_k10_full"
