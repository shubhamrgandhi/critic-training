#!/bin/bash
#SBATCH --job-name=qwen3_8b_prm_clean_vllm
...
MODEL="${MODEL:-/data/user_data/srgandhi/saves/qwen3-8b-full-sft-prm-opus-distill-32k-lr5e6_clean_think}"
SERVED_NAME="qwen3-8b-full-sft-prm-opus-distill-32k-lr5e6_clean_think"
PORT=8071
...
echo "=== vLLM Server Starting (Finetuned PRM Clean) ==="
