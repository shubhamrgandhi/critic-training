...
MODEL="${MODEL:-/data/user_data/srgandhi/saves/qwen3-8b-full-sft-prm-opus-distill-32k-lr5e6_clean}"
SERVED_NAME="qwen3-8b-full-sft-prm-opus-distill-32k-lr5e6_clean"
PORT=8071
