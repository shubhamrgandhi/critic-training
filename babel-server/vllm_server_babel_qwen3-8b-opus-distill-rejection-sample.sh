#!/bin/bash
#SBATCH --job-name=qwen3_8b_prm_rs_vllm
...
MODEL="${MODEL:-/data/user_data/srgandhi/saves/qwen3-8b-full-sft-prm-opus-distill-32k-lr5e6_rejection-sample}"
SERVED_NAME="qwen3-8b-full-sft-prm-opus-distill-32k-lr5e6_rejection-sample"
PORT=8071
...
echo "=== vLLM Server Starting (Finetuned PRM Rejection Sample) ==="
